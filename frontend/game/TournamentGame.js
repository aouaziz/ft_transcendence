...
export async function loadTournamentGamePage() {
  ...
  const tournamentText = document.getElementById("tournament");
  
  if (!player1Name || !player2Name) {
    tournamentText.style.display='none'
    popupText.textContent = "Error: No match found. Please ensure All players are set.";
    ...
    popupBtn.addEventListener('click', openErrorpopup);
    return; 
  }
